...
function Columns(props){
    ...
    const itemdelete = (props) => {
        setopen(false)
        noview(false)
        const link = "http://34.64.95.170:8080/del"
    ...
    {(view) && <div style={{display:"flex", width:"100%", flexDirection:"row", background:props.bgcolor}}>
        ...
        <div style={{display:"flex", borderRight:"1px solid #D0CFD2", height:"6.5vh", width:"37%", overflow:"auto"}}><p style={{textAlign:"center", margin:"auto"}}>{props.review}</p></div>
